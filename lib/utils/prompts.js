...
const prompts = {
  ...
  german: {
    WELCOME: 'Willkommen beim automatischen Übersetzungsdienst.',
    ENTER_NUMBER: 'Bitte geben Sie die zehnstellige Telefonnummer ein, die Sie anrufen möchten, indem Sie das Tastenfeld auf Ihrem Telefon verwenden.',
    ARE_YOU_THERE: 'Sind Sie noch da?',
    SELECT_LANGUAGE_PREAMBLE: 'Großartig! Bitte wählen Sie nun die Sprache aus, die die Person spricht, die Sie anrufen.',
    FINAL_PROMPT: 'Wir verbinden Ihren Anruf jetzt mit einem Übersetzer in der Leitung. Wenn Sie den Übersetzer jederzeit aus dem Anruf entfernen möchten, drücken Sie einfach Stern eins. Drücken Sie erneut Stern eins, um den Übersetzer wieder hinzuzufügen. Bitte halten Sie jetzt die Leitung, während wir Ihren Anruf verbinden.',
    TRANSLATOR_OFF: 'Übersetzer aus',
    TRANSLATOR_ON: 'Übersetzer an',
  },
  turkish: {
    WELCOME: 'Otomatik çeviri hizmetine hoş geldiniz.',
    ENTER_NUMBER: 'Telefonunuzun tuş takımını kullanarak aramak istediğiniz on haneli telefon numarasını giriniz.',
    ARE_YOU_THERE: 'Hala orada mısınız?',
    SELECT_LANGUAGE_PREAMBLE: 'Harika! Şimdi lütfen aradığınız kişinin konuştuğu dili seçin.',
    FINAL_PROMPT: 'Şimdi çağrınızı bir tercümanla bağlayacağız. Herhangi bir zamanda tercümanı görüşmeden çıkarmak isterseniz, yıldız bir tuşuna basmanız yeterlidir. Tercümanı görüşmeye geri eklemek için tekrar yıldız bir tuşuna basın. Şimdi lütfen bekleyin, çağrınızı bağlıyoruz.',
    TRANSLATOR_OFF: 'çevirmen kapalı',
    TRANSLATOR_ON: 'çevirmen açık',
  },
  arabic: {
